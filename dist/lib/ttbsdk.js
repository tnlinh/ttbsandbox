...
(function () {
  ...
  window.TTB.prototype = {
     ...
     * @param {Object} data - A data object retrieved from te response of certain of API, against which auto-fill needs to be processed.
     *
     * */
     ...
     * @param {String} payload.autoFillContext - A query selector of an element(s) inside which to look for inputs elements
